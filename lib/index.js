...
exports.Client = exports.ThumbsUpDown = void 0;
const uuid_1 = require("uuid");
const md5_1 = __importDefault(require("crypto-js/md5"));
var ThumbsUpDown_1 = require("./components/ThumbsUpDown");
Object.defineProperty(exports, "ThumbsUpDown", { enumerable: true, get: function () { return __importDefault(ThumbsUpDown_1).default; } });
class Client {
    ...
    logDialogue({ instruction, response, configName, id = (0, uuid_1.v4)(), groupId, createdBy }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch(`${this.baseUrl}/api/v0/log-dialogue`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
